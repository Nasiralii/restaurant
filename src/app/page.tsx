            ...
            <section key={category.id} id={category.id} className="scroll-mt-24">
              <div className="flex flex-col gap-2 px-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <p className="text-xs text-[#6b5b4f]">
                  Updated today • 5–8 items per section
                </p>
              </div>
  ...
  <div className="w-full max-w-400 mx-auto px-4 py-16 sm:px-6 lg:px-10 xl:px-16">
    <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="lg:col-span-1">
        <p className="text-lg font-semibold text-[#1f1a14]">Brew & Bite</p>
        <p className="mt-3 text-sm leading-7 text-[#5b4b3f]">
          A cozy corner cafe serving handcrafted espresso drinks, freshly baked
          desserts, and refreshing beverages — all day, every day.
        </p>
      ...
      {/* Quick Links */}
      <div>
        <p className="text-sm font-semibold text-[#1f1a14]">Menu</p>
        <ul className="mt-3 space-y-2 text-sm text-[#5b4b3f]">
          <li><a href="#coffee" className="hover:text-[#c28a52] transition">Coffee</a></li>
          <li><a href="#desserts" className="hover:text-[#c28a52] transition">Desserts</a></li>
          <li><a href="#drinks" className="hover:text-[#c28a52] transition">Drinks</a></li>
        </ul>
        <p className="mt-6 text-sm font-semibold text-[#1f1a14]">Hours</p>
        <ul className="mt-3 space-y-2 text-sm text-[#5b4b3f]">
          <li className="flex justify-between gap-4"><span>Sat – Thu</span><span>8:00 AM – 12:00 AM</span></li>
          <li className="flex justify-between gap-4"><span>Friday</span><span>2:00 PM – 1:00 AM</span></li>
        </ul>
      </div>

      {/* Contact */}
      <div>
        <p className="text-sm font-semibold text-[#1f1a14]">Contact</p>
        <ul className="mt-3 space-y-3 text-sm text-[#5b4b3f]">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Al Olaya District, Riyadh 12211, Saudi Arabia</span>
          </li>
          <li className="flex items-start gap-2">
            ...
            <span>hello@brewandbite.sa</span>
          </li>
        </ul>
      </div>
      ...
      {/* Map */}
      <div>
        <p className="text-sm font-semibold text-[#1f1a14]">Find Us</p>
    ...
    <div className="mt-12 border-t border-black/10 pt-6 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between text-xs text-[#6b5b4f]">
      <p>© {new Date().getFullYear()} Brew & Bite. All rights reserved.</p>
      <div className="flex gap-4">
        <a href="#" className="hover:text-[#c28a52] transition">Privacy Policy</a>
        <a href="#" className="hover:text-[#c28a52] transition">Terms of Use</a>
      </div>
    </div>
  </div>
</footer> 
